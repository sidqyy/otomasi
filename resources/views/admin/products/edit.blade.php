                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('admin.products.update', $product->id) }}">
                        ...
                        <div class="mt-4">
                            ...
                            <textarea id="description" name="description" rows="4" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full">{{ old('description', $product->description) }}</textarea>
                        ...
                        <div class="block mt-4">
                            <label for="is_ready" class="inline-flex items-center">
                                <input id="is_ready" type="checkbox" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" name="is_ready" value="1" {{ old('is_ready', $product->is_ready) ? 'checked' : '' }}>
