                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('admin.faqs.update', $faq->id) }}">
                        ...
                        <div class="mt-4">
                            ...
                            <textarea id="answer" name="answer" rows="4" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full" required>{{ old('answer', $faq->answer) }}</textarea>
